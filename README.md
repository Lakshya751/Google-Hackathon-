...
**Note:** The full source code and implementation details are maintained in a private repository for security and privacy reasons (collaborated). This public repository contains the documentation and submission materials for the hackathon. The whole codebase is kept private as it was a group project. 
